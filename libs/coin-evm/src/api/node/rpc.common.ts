...
import { RpcApi, isExternalNodeConfig } from "./types";
 ...
 */
export const getTransaction: RpcApi["getTransaction"] = (currency, txHash) =>
 ...
 */
export const getCoinBalance: RpcApi["getCoinBalance"] = (currency, address) =>
  withApi(currency, async api => {
 ...
 * Get the balance of an address
 */
export const getTokenBalance: RpcApi["getTokenBalance"] = (currency, address, contractAddress) =>
  withApi(currency, async api => {
 ...
 * Get account nonce
 */
export const getTransactionCount: RpcApi["getTransactionCount"] = (currency, address) =>
  withApi(currency, async api => {
 ...
 */
export const getGasEstimation: RpcApi["getGasEstimation"] = (account, transaction) =>
 ...
 */
// Waiting for proxies
export const getFeesEstimation: RpcApi["getFeesEstimation"] = currency =>
  withApi(currency, async api => {
 ...
 */
export const broadcastTransaction: RpcApi["broadcastTransaction"] = (currency, signedTxHex) =>
  withApi(
    currency,
    async api => {
      try {
 ...
 */
export const getBlockByHeight: RpcApi["getBlockByHeight"] = (currency, blockHeight = "latest") =>
  withApi(currency, async api => {
 ...
 */
//
export const getOptimismAdditionalFees: RpcApi["getOptimismAdditionalFees"] = makeLRUCache(
